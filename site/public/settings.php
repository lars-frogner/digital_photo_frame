...
<body>
  ...
  <main>
    <div class="container">
      <h1 class="my-4">Innstillinger</h1>
      <form id="display_settings_form" action="" method="post">
        <div class="row">
          <?php generateInputs($setting_type, $grouped_values); ?>
        </div>
        <div class="my-4">
          <button type="submit" name="submit" class="btn btn-primary">Bekreft</button>
          <button name="undo" class="btn btn-secondary" onclick="$('#display_settings_form').trigger('reset');">Angre</button>
...
<script>
  const SETTINGS_FORM_ID = 'display_settings_form';
